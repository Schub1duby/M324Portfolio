...
## Unit-Test
Ein Unit-Test überprüft die kleinsten Komponenten der Software, beispielsweise Methoden und Klassen.
...
Prompt:
> In welcher der acht DevOps Phasen werden welche Testarten (Unit-, Integrations-, System- und Akzeptanztest) ausgeführt und wieso? Fasse dich kurz sofern möglich
...
In der heutigen Zeit ist es ziemlich Schwierig, mit Google gescheite Informationen zu Finden. Am besten Erklärt hat der folgende Artikel: https://www.nagler-company.com/de/unternehmen/aktuelles/artikel-anzeigen/automatisiertes-testen-im-devops-umfeld.html
...
Ebenfalls stellten wir bei der Recherche zu Karma fest, dass Mocha mit Karma läuft.

Jasmine
Jasmine ist ein Tool, welches drei Installationsavarianten bietet. Standalone, im Browser oder über Node.js. Ebenfalls ist das Tool ein Open-Source Projekt.
...
Das bereits erläuterte Programm erweitern wir jetzt um ein paar Tests mithilfe von Jasmine.
Meine Javascript Testdatei liess ich von ChatGPT generieren, da ich nicht die nötigen Kenntnisse habe, um dies selbst zu erledigen.
...
# Suche und baue das Dockerfile
    ...
    restart: always
```
Zu beachten ist, dass die Dateien index.html, Dockerfile und docker-compose.yml im gleichen Verzeichnis sind, sonst funktioniert die obigen Konfigurationen nicht.
...
Dann ist die Applikation lokal unter folgendem Link abrufbar: http://localhost:8080/index.html
...
lternativen zu Docker. Wir haben uns Hyper-V-Container kurz angesehen, realisierten jedoch in Kürze, dass diese Variante für uns nicht passt.
...
Da wir keinen Zugriff auf das AWS Learner Lab hatten, haben wir uns dazu entschieden die Applikation auf Azure zu deployen. 
...
Wichtig ist, dass man bei den Build-Optionen HTML angibt und, da unsere Applikation in diesem Fall im Root-Verzeichnis liegt, auch das Root-Verzeichnis angibt.
...
Grundsätzlich funktionieren die sehr ähnlich und bieten auch unterschiedliche Funktionen. Sie unterscheiden sich meist durch Serverstandorte und Privacy Policy unterschieden. Am Ende bleiben aber alle extrem teuer.. 
...
- Jasmine Documentation, Open-Source, Getting Started, o. D.,https://jasmine.github.io/pages/getting_started.html
- Karma Runner, o. D., https://karma-runner.github.io/latest/index.html
- Google Testing Blog, Vojta Jina, Testacular - Spectacular Test Runner for JavaScript, 27.12.2025, https://testing.googleblog.com/2012/11/testacular-spectacular-test-runner-for.html
- Browserstack, Top 9 JavaScript Testing Frameworks, 13.03.2025, https://www.browserstack.com/guide/top-javascript-testing-frameworks
## Bildquellen
...
- Rechtschreibekorrektur mithilfe von ChatGPT Modell 4o, 19.03.2025, ![ChatGPT Prompt zur Rechtschreibecheck](https://i.imgur.com/joJdF50.jpeg)
